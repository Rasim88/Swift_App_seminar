...
final class ThemeView: UIView{
    ...
    init(){
        ...
        button1.addTarget(self, action: #selector(tap1), for: UIControl.Event.touchUpInside)
        button2.addTarget(self, action: #selector(tap2), for: UIControl.Event.touchUpInside)
        button3.addTarget(self, action: #selector(tap3), for: UIControl.Event.touchUpInside)
        setupViews()
    }
